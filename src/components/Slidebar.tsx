  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 flex items-center justify-center">
      <div className="w-full max-w-4xl">
        <div className="bg-gray-900 bg-opacity-70 text-white rounded-t-xl p-8 relative overflow-hidden">
          <button
            onClick={prevSlide}
              ...
              >
                <div className="text-center px-10 h-full flex flex-col justify-center">
                  <div className="flex justify-center mb-3">
                    <div className="w-20 h-20 rounded-full bg-white bg-opacity-50 flex items-center justify-center border border-yellow-300"> {/* Light transparent background */}
                      <img
                        src={review.image}
                        alt={review.name}
